const createAutoScrollComponent = () => { 
    ...
    <section class="mx-auto flex flex-row relative mb-14">
        <div class="auto-scroll-content whitespace-nowrap animate-scroll" id="auto-scroll-content overflow-hidden" >                     
            <div class="inline-flex items-center h-[134px] w-[238px] p-[3px] tab:p-[5px] tab2:p-[8px] tab:h-[161px] tab:w-[286px] tab2:w-[417px] tab2:h-[236px] tab2:py-[20px]">
        ...
        <div class="m-3 h-6 w-6 rounded-full absolute right-0 -bottom-14 bg-gray-200 hover:bg-gray-300 flex z-10">
